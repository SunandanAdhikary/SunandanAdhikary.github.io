	...
	<div id="home">
		<div class="container">
			<div class="row">
				...
				<div class="hero-unit"
					style="background-color:rgba(10, 10, 10, 0.6); line-height: 1250px; padding: 20px;">
					<h2>Welcome to </h2>
					...
					<!-- <> -->
						...
						<div class="clearfix" style="width: 100%;">
							...
							<div class="blockquote-reverse">
								<span class=""><a href="https://www.qualcomm.com/invention/research/university-relations/innovation-fellowship/winners">Srijeeta Maity and Anirban Ghose awarded with Qualcomm
	...
	<div class="divider">
		<div class="container" id="research">
			...
			<div class="row" style="padding: 20px;">
				...
				<div class="col-md-6 col-sm-6 card" style="padding:15px">
					<div class="divider-wrapper divider-two" data-toggle="collapse" data-target="#rts-description">
				...
				<div class="col-md-6 col-sm-6 card" style="padding:15px">
					<div class="divider-wrapper divider-one" data-toggle="collapse" data-target="#sg-description">
			...
			<div class="row" style="padding: 20px;">
				...
				<div class="divider-wrapper divider-two" style="padding: 15px" data-toggle="collapse" data-target="#mcn-description">
					<i class="fa fa-wifi" aria-hidden="true"></i>
					<h2>Wireless multi-hop control networks (MCN)</h2>
					<p id="mcn-description" class="collapse">Wireless multi-hop control networks (MCN) facilitate real-time monitoring and control for a
