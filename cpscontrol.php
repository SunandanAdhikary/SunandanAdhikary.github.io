...
<body>
	<!-- header section -->
	<div class="container">
		<div class="row" style="padding:15px" id="cpsconbanner">
			<div class="col-md-12 col-sm-12">
				<div class="hero-unit back-img-caption">
					<h1><span>Control-Scheduling Co-Design of CPS</span></h1>
					<p>The growing demand for mapping diverse embedded applications on shared processors has
		...
		<div class="row">
			<div class="container topic-desc">
				<div style="width:100% " data-toggle="collapse" data-target="#cpscontrol-topic3">
					<div class="header-content-container">
						<h2>Co-design of Fault Tolerent Networked CPS <span class="caret"></span></h2>
					</div>
					<div class="collapse" id="cpscontrol-topic3">
						<div class="col-md-7 col-sm-7">
