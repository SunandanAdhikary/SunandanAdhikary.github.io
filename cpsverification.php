...
<body>
	<!-- header section -->
	<div class="container">
		<div class="row banner-block" style="padding:15px" id="cpsverbanner"
			style="background-image: url(/images/cps/Tool_Flow_figure.png);">
			<div class="col-md-12 col-sm-12">
				<div class="hero-unit back-img-caption">
					<h1><span>Safety-Critical CPS Design Verification</span></h1>
					<p>Safety violations and cyber-attacks due to design or implementation errors in safety-critical
				...
				<div class="container topic-desc">
					<div style="width:100% " data-toggle="collapse" data-target="#cpsver-topic1">
						<div class="header-content-container">
							<h2>Safety Analysis of Embedded Controllers<span class="caret"></span></h2>
						</div>
						<div class="collapse" id="cpsver-topic1">
							<div class="col-md-7 col-sm-7">
								<p> Control software often executes on common embedded platforms
									...
									these perturbations
									when a control program runs in closeed loop with some plant. None of them considers
									controller program
			...
			<div class="row">
				<div class="container topic-desc">
					<div style="width:100% " data-toggle="collapse" data-target="#cpsver-topic2">
						<div class="header-content-container">
							<h2>Vulnerability Analysis of Safety-Critical CPS<span class="caret"></span></h2>
						</div>
						<div class="collapse" id="cpsver-topic2">
							<div class="col-md-7 col-sm-7">
								<p class="text-justify"> We have developed methods to find security loopholes by analysing safety of these
									...
									robust the control systems is towards such anomalies. Using this approach we can as well
									understand how an attacker functions and make it more realistic by imposing
									real-world
									constraints. We can intelligently mine these system parameters that can restraint
									the
									accessibility of system vulnerabilities. Along with analyzing vulnerabilities we are
									also interested in system control behaviours and how are those affected when such
									attack
									scenarios arise in real world. As we are interested in provably secure such systems,
									we
									utilize several verification tools like <a href="">Z3</a>, <a href="">dReal</a> to
									analyse system vulnerabilities. </p>
							</div>
							<div class="col-md-5 col-sm-5" style="padding:0px 5px 0px 5px">
