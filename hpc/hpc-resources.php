...
<div class="row text-center" style="padding:15px">
    <div class="header">
        <h1 ><span>GPGPU Resources</span></h1>
    </div>
</div>
<br><br>

        
<div class="container topic-desc" style= "padding: 50px;background-color: white; color:black;" data-toggle="collapse" data-target="#learning">
...
<div class="container topic-desc" style= "padding: 50px;background-color: white; color:black;" data-toggle="collapse" data-target="#trivia">
...
<div class="container topic-desc" style= "padding: 50px;background-color: white; color:black;" data-toggle="collapse" data-target="#library">
