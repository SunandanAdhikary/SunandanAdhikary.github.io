...
<body>
	<!-- header section -->
	<div class="container">
		<div class="row" style="padding:15px" id="cpsrelbanner">
			<div class="col-md-12 col-sm-12">
				<div class="hero-unit back-img-caption">
					<h1><span>Reliable CPS Design</span></h1>
					<p>Traditionally, the reliability of safety-critical systems has
		...
		<div class="container">
			...
			<div class="row">
				<div class="container topic-desc">
					<div style="width:100% " data-toggle="collapse" data-target="#cpsrel-topic1">
						<div class="header-content-container">
							<h2>Reliability Analysis of CPS <span class="caret"></span></h2>
						</div>
			...
			<div class="row">
				<div class="container topic-desc">
					<div style="width:100% " data-toggle="collapse" data-target="#cpsrel-topic2">
						<div class="header-content-container">
							<h2>Reliability-Aware Scheduling of CPS<span class="caret"></span>
							</h2>
						</div>
						<div class="collapse" id="cpsrel-topic2">
							<div class="col-md-7 col-sm-7">
								<p> By verifying the performance degradation
									...
									mitigation techniques are developed. The system shows signifiant reliability
