...
<body>
	...
	<div id="cpsCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="item active">
				...
				<div class="container">
					<div class="carousel-caption back-img-caption" style="top:40%;bottom:40%">
	...
	<div class="container">
		<div class="row  industry" style="padding:15px">
			...
			<a href="http://www.ieee-cps.org/" style="font-weight:bold;margin:10px 2px 0px 0px">[ IEEE Technical Committee ]</a></p>
			</div>
